...
app.get('/user/tweets/', authentication, async (request, response) => {
  ...
  From tweet LEFT JOIN reply ON tweet.tweet_id = reply.tweet_id LEFT JOIN like ON tweet.tweet_id = like_tweet_id
